...
class SMS(object):
    ...
    def __init__(self):
        """
        SMS - a model defined in Swagger
    ...
    def nsu(self):
        """
        Gets the nsu of this SMS.
        N\u00C3\u00BAmero sequencial \u00C3\u00BAnico.

        :return: The nsu of this SMS.
        :rtype: int
        """
        return self._nsu
    ...
    def nsu(self, nsu):
        """
        Sets the nsu of this SMS.
        N\u00C3\u00BAmero sequencial \u00C3\u00BAnico.

        :param nsu: The nsu of this SMS.
        :type: int
        """
        self._nsu = nsu
    ...
    def id_emissor(self):
        """
        Gets the id_emissor of this SMS.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o do emissor (id).

        :return: The id_emissor of this SMS.
        :rtype: int
        """
    ...
    def id_emissor(self, id_emissor):
        """
        Sets the id_emissor of this SMS.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o do emissor (id).

        :param id_emissor: The id_emissor of this SMS.
        :type: int
        """
    ...
    def id_pessoa(self):
        ...
        :return: The id_pessoa of this SMS.
        :rtype: int
        """
    ...
    def id_pessoa(self, id_pessoa):
        """
        Sets the id_pessoa of this SMS.
        C\u00C3\u00B3digo identificado da pessoa

        :param id_pessoa: The id_pessoa of this SMS.
        :type: int
        """
    ...
    def id_conta(self):
        """
        Gets the id_conta of this SMS.
        C\u00C3\u00B3digo identificador da conta

        :return: The id_conta of this SMS.
        :rtype: int
        """
    ...
    def id_conta(self, id_conta):
        """
        Sets the id_conta of this SMS.
        C\u00C3\u00B3digo identificador da conta

        :param id_conta: The id_conta of this SMS.
        :type: int
        """
    ...
    def celular(self, celular):
        """
        Sets the celular of this SMS.
        Apresenta o celular a ser eviado o SMS no formato 5588999999999 ou 5588999999999

        :param celular: The celular of this SMS.
        :type: str
        """
    ...
    def conteudo(self):
        ...
        :return: The conteudo of this SMS.
        :rtype: str
        """
    ...
    def conteudo(self, conteudo):
        """
        Sets the conteudo of this SMS.
        Apresenta o texto da notifica\u00C3\u00A7\u00C3\u00A3o a ser enviado

        :param conteudo: The conteudo of this SMS.
        :type: str
        """
    ...
    def data_agendamento(self):
        """
        Gets the data_agendamento of this SMS.
    ...
    def data_agendamento(self, data_agendamento):
        """
        Sets the data_agendamento of this SMS.
        Apresenta a data e hora em que ser\u00C3\u00A1 enviado a notifica\u00C3\u00A7\u00C3\u00A3o
    ...
    def quantidade_tentativas_envio(self):
        """
        Gets the quantidade_tentativas_envio of this SMS.
        Quantidade de tentativas e envio da notifica\u00C3\u00A7\u00C3\u00A3o

        :return: The quantidade_tentativas_envio of this SMS.
        :rtype: int
        """
    ...
    def quantidade_tentativas_envio(self, quantidade_tentativas_envio):
        """
        Sets the quantidade_tentativas_envio of this SMS.
        Quantidade de tentativas e envio da notifica\u00C3\u00A7\u00C3\u00A3o

        :param quantidade_tentativas_envio: The quantidade_tentativas_envio of this SMS.
        :type: int
        """
    ...
    def data_inclusao(self):
        """
        Gets the data_inclusao of this SMS.
    ...
    def data_inclusao(self, data_inclusao):
        """
        Sets the data_inclusao of this SMS.
        Apresenta a data e em que o registro foi inclu\u00C3\u00ADdo na base para ser enviado
    ...
    def data_alteracao_status(self):
        """
        Gets the data_alteracao_status of this SMS.
    ...
    def data_alteracao_status(self, data_alteracao_status):
        """
        Sets the data_alteracao_status of this SMS.
        Apresenta a data e em que o Stattjus do registro foi modificado
    ...
    def protocolo(self):
        """
        Gets the protocolo of this SMS.
        N\u00C3\u00BAmero do protocolo de envio de notifica\u00C3\u00A7\u00C3\u00B5es

        :return: The protocolo of this SMS.
        :rtype: str
        """
    ...
    def protocolo(self, protocolo):
        """
        Sets the protocolo of this SMS.
        N\u00C3\u00BAmero do protocolo de envio de notifica\u00C3\u00A7\u00C3\u00B5es

        :param protocolo: The protocolo of this SMS.
        :type: str
        """
