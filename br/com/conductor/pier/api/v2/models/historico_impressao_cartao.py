...
class HistoricoImpressaoCartao(object):
    """
    ...
    def __init__(self):
        """
        HistoricoImpressaoCartao - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Hist\u00C3\u00B3rico de Impress\u00C3\u00A3o Avulsa de Cart\u00C3\u00B5es (id).

        :return: The id of this HistoricoImpressaoCartao.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Hist\u00C3\u00B3rico de Impress\u00C3\u00A3o Avulsa de Cart\u00C3\u00B5es (id).

        :param id: The id of this HistoricoImpressaoCartao.
        :type: int
        """
        self._id = id
    ...
    def id_cartao(self):
        """
        Gets the id_cartao of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cart\u00C3\u00A3o (id).

        :return: The id_cartao of this HistoricoImpressaoCartao.
        :rtype: int
        """
    ...
    def id_cartao(self, id_cartao):
        """
        Sets the id_cartao of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cart\u00C3\u00A3o (id).

        :param id_cartao: The id_cartao of this HistoricoImpressaoCartao.
        :type: int
        """
    ...
    def id_status_impressao_cartao(self):
        """
        Gets the id_status_impressao_cartao of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Status de Impress\u00C3\u00A3o do Cart\u00C3\u00A3o (id).

        :return: The id_status_impressao_cartao of this HistoricoImpressaoCartao.
        :rtype: int
        """
    ...
    def id_status_impressao_cartao(self, id_status_impressao_cartao):
        """
        Sets the id_status_impressao_cartao of this HistoricoImpressaoCartao.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Status de Impress\u00C3\u00A3o do Cart\u00C3\u00A3o (id).

        :param id_status_impressao_cartao: The id_status_impressao_cartao of this HistoricoImpressaoCartao.
        :type: int
        """
    ...
    def mensagem_historico(self):
        """
        Gets the mensagem_historico of this HistoricoImpressaoCartao.
        Apresenta uma mensagem que descreve a etapa do processo de impress\u00C3\u00A3o do cart\u00C3\u00A3o que fora realizado.

        :return: The mensagem_historico of this HistoricoImpressaoCartao.
        :rtype: str
        """
    ...
    def mensagem_historico(self, mensagem_historico):
        """
        Sets the mensagem_historico of this HistoricoImpressaoCartao.
        Apresenta uma mensagem que descreve a etapa do processo de impress\u00C3\u00A3o do cart\u00C3\u00A3o que fora realizado.

        :param mensagem_historico: The mensagem_historico of this HistoricoImpressaoCartao.
        :type: str
        """
