...
class DispositivoPersist(object):
    """
    ...
    def __init__(self):
        """
        DispositivoPersist - a model defined in Swagger
    ...
    def token(self):
        """
        Gets the token of this DispositivoPersist.
        Apresenta o token do dispositivo.

        :return: The token of this DispositivoPersist.
        :rtype: str
        """
        return self._token
    ...
    def token(self, token):
        """
        Sets the token of this DispositivoPersist.
        Apresenta o token do dispositivo.

        :param token: The token of this DispositivoPersist.
        :type: str
        """
        self._token = token
