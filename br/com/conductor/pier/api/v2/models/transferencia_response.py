...
class TransferenciaResponse(object):
    ...
    def nome_pessoa_origem(self):
        """
        Gets the nome_pessoa_origem of this TransferenciaResponse.
        Apresenta o nome completo da pessoa que realizou a Transfer\u00C3\u00AAncia.

        :return: The nome_pessoa_origem of this TransferenciaResponse.
        :rtype: str
        """
    ...
    def nome_pessoa_origem(self, nome_pessoa_origem):
        """
        Sets the nome_pessoa_origem of this TransferenciaResponse.
        Apresenta o nome completo da pessoa que realizou a Transfer\u00C3\u00AAncia.

        :param nome_pessoa_origem: The nome_pessoa_origem of this TransferenciaResponse.
        :type: str
        """
    ...
    def nome_pessoa_destino(self):
        """
        Gets the nome_pessoa_destino of this TransferenciaResponse.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cliente Portador Cart\u00C3\u00A3o que ser\u00C3\u00A1 creditado (id).

        :return: The nome_pessoa_destino of this TransferenciaResponse.
        :rtype: str
        """
    ...
    def nome_pessoa_destino(self, nome_pessoa_destino):
        """
        Sets the nome_pessoa_destino of this TransferenciaResponse.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cliente Portador Cart\u00C3\u00A3o que ser\u00C3\u00A1 creditado (id).

        :param nome_pessoa_destino: The nome_pessoa_destino of this TransferenciaResponse.
        :type: str
        """
    ...
    def valor_tarifa(self):
        """
        Gets the valor_tarifa of this TransferenciaResponse.
        Valor estabelecido da tarifa para a transfer\u00C3\u00AAncia.

        :return: The valor_tarifa of this TransferenciaResponse.
        :rtype: float
        """
    ...
    def valor_tarifa(self, valor_tarifa):
        """
        Sets the valor_tarifa of this TransferenciaResponse.
        Valor estabelecido da tarifa para a transfer\u00C3\u00AAncia.

        :param valor_tarifa: The valor_tarifa of this TransferenciaResponse.
        :type: float
        """
