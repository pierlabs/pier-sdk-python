...
class Transferencia(object):
    ...
    def id(self):
        """
        Gets the id of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da transfer\u00C3\u00AAncia (id).

        :return: The id of this Transferencia.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da transfer\u00C3\u00AAncia (id).

        :param id: The id of this Transferencia.
        :type: int
        """
        self._id = id
    ...
    def data_transferencia(self):
        """
        Gets the data_transferencia of this Transferencia.
    ...
    def data_transferencia(self, data_transferencia):
        """
        Sets the data_transferencia of this Transferencia.
        Data estabelecida para ocorrer a transfer\u00C3\u00AAncia.
    ...
    def id_conta_origem(self):
        """
        Gets the id_conta_origem of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta em que o valor ser\u00C3\u00A1 debitado para a transfer\u00C3\u00AAncia. (id).

        :return: The id_conta_origem of this Transferencia.
        :rtype: int
        """
    ...
    def id_conta_origem(self, id_conta_origem):
        """
        Sets the id_conta_origem of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta em que o valor ser\u00C3\u00A1 debitado para a transfer\u00C3\u00AAncia. (id).

        :param id_conta_origem: The id_conta_origem of this Transferencia.
        :type: int
        """
    ...
    def nome_pessoa_origem(self):
        """
        Gets the nome_pessoa_origem of this Transferencia.
        Apresenta o nome completo da pessoa que realizou a Transfer\u00C3\u00AAncia.

        :return: The nome_pessoa_origem of this Transferencia.
        :rtype: str
        """
    ...
    def nome_pessoa_origem(self, nome_pessoa_origem):
        """
        Sets the nome_pessoa_origem of this Transferencia.
        Apresenta o nome completo da pessoa que realizou a Transfer\u00C3\u00AAncia.

        :param nome_pessoa_origem: The nome_pessoa_origem of this Transferencia.
        :type: str
        """
    ...
    def id_conta_destino(self):
        """
        Gets the id_conta_destino of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta em que o valor ser\u00C3\u00A1 creditado para a transfer\u00C3\u00AAncia. (id).

        :return: The id_conta_destino of this Transferencia.
        :rtype: int
        """
    ...
    def id_conta_destino(self, id_conta_destino):
        """
        Sets the id_conta_destino of this Transferencia.
        C\u00C3\u00B3digo de identifica\u00C3\u00A7\u00C3\u00A3o da conta em que o valor ser\u00C3\u00A1 creditado para a transfer\u00C3\u00AAncia. (id).

        :param id_conta_destino: The id_conta_destino of this Transferencia.
        :type: int
        """
    ...
    def nome_pessoa_destino(self):
        """
        Gets the nome_pessoa_destino of this Transferencia.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cliente Portador Cart\u00C3\u00A3o que ser\u00C3\u00A1 creditado (id).

        :return: The nome_pessoa_destino of this Transferencia.
        :rtype: str
        """
    ...
    def nome_pessoa_destino(self, nome_pessoa_destino):
        """
        Sets the nome_pessoa_destino of this Transferencia.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Cliente Portador Cart\u00C3\u00A3o que ser\u00C3\u00A1 creditado (id).

        :param nome_pessoa_destino: The nome_pessoa_destino of this Transferencia.
        :type: str
        """
    ...
    def valor_transferencia(self):
        """
        Gets the valor_transferencia of this Transferencia.
        Valor estabelecido para ser transferido.

        :return: The valor_transferencia of this Transferencia.
        :rtype: float
        """
    ...
    def valor_transferencia(self, valor_transferencia):
        """
        Sets the valor_transferencia of this Transferencia.
        Valor estabelecido para ser transferido.

        :param valor_transferencia: The valor_transferencia of this Transferencia.
        :type: float
        """
    ...
    def valor_tarifa(self):
        """
        Gets the valor_tarifa of this Transferencia.
        Valor estabelecido da tarifa para a transfer\u00C3\u00AAncia.

        :return: The valor_tarifa of this Transferencia.
        :rtype: float
        """
    ...
    def valor_tarifa(self, valor_tarifa):
        """
        Sets the valor_tarifa of this Transferencia.
        Valor estabelecido da tarifa para a transfer\u00C3\u00AAncia.

        :param valor_tarifa: The valor_tarifa of this Transferencia.
        :type: float
        """
