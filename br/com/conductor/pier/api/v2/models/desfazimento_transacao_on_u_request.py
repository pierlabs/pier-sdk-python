...
class DesfazimentoTransacaoOnURequest(object):
    """
    ...
    def __init__(self):
        """
        DesfazimentoTransacaoOnURequest - a model defined in Swagger
    ...
    def nsu_origem(self):
        """
        Gets the nsu_origem of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero Sequencial \u00C3\u009Anico que identifica a transa\u00C3\u00A7\u00C3\u00A3o no sistema que a originou.

        :return: The nsu_origem of this DesfazimentoTransacaoOnURequest.
        :rtype: str
        """
    ...
    def nsu_origem(self, nsu_origem):
        """
        Sets the nsu_origem of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero Sequencial \u00C3\u009Anico que identifica a transa\u00C3\u00A7\u00C3\u00A3o no sistema que a originou.

        :param nsu_origem: The nsu_origem of this DesfazimentoTransacaoOnURequest.
        :type: str
        """
    ...
    def codigo_processamento(self):
        ...
        :return: The codigo_processamento of this DesfazimentoTransacaoOnURequest.
        :rtype: str
        """
    ...
    def codigo_processamento(self, codigo_processamento):
        """
        Sets the codigo_processamento of this DesfazimentoTransacaoOnURequest.
        C\u00C3\u00B3digo de Processamento que identifica o Tipo da Transa\u00C3\u00A7\u00C3\u00A3o.

        :param codigo_processamento: The codigo_processamento of this DesfazimentoTransacaoOnURequest.
        :type: str
        """
    ...
    def valor_transacao(self):
        """
        Gets the valor_transacao of this DesfazimentoTransacaoOnURequest.
        Valor da transa\u00C3\u00A7\u00C3\u00A3o com duas casas decimais para os centavos.

        :return: The valor_transacao of this DesfazimentoTransacaoOnURequest.
        :rtype: float
        """
    ...
    def valor_transacao(self, valor_transacao):
        """
        Sets the valor_transacao of this DesfazimentoTransacaoOnURequest.
        Valor da transa\u00C3\u00A7\u00C3\u00A3o com duas casas decimais para os centavos.

        :param valor_transacao: The valor_transacao of this DesfazimentoTransacaoOnURequest.
        :type: float
        """
    ...
    def numero_real_cartao(self):
        """
        Gets the numero_real_cartao of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero Real do Cart\u00C3\u00A3o.

        :return: The numero_real_cartao of this DesfazimentoTransacaoOnURequest.
        :rtype: str
        """
    ...
    def numero_real_cartao(self, numero_real_cartao):
        """
        Sets the numero_real_cartao of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero Real do Cart\u00C3\u00A3o.

        :param numero_real_cartao: The numero_real_cartao of this DesfazimentoTransacaoOnURequest.
        :type: str
        """
    ...
    def data_validade_cartao(self):
        """
        Gets the data_validade_cartao of this DesfazimentoTransacaoOnURequest.
        Data de Validade do Cart\u00C3\u00A3o. Ex: AAMM

        :return: The data_validade_cartao of this DesfazimentoTransacaoOnURequest.
        :rtype: str
        """
    ...
    def data_validade_cartao(self, data_validade_cartao):
        """
        Sets the data_validade_cartao of this DesfazimentoTransacaoOnURequest.
        Data de Validade do Cart\u00C3\u00A3o. Ex: AAMM

        :param data_validade_cartao: The data_validade_cartao of this DesfazimentoTransacaoOnURequest.
        :type: str
        """
    ...
    def numero_estabelecimento(self):
        """
        Gets the numero_estabelecimento of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero do Estabelecimento (N\u00C3\u00BAmero+DV).

        :return: The numero_estabelecimento of this DesfazimentoTransacaoOnURequest.
        :rtype: int
        """
    ...
    def numero_estabelecimento(self, numero_estabelecimento):
        """
        Sets the numero_estabelecimento of this DesfazimentoTransacaoOnURequest.
        N\u00C3\u00BAmero do Estabelecimento (N\u00C3\u00BAmero+DV).

        :param numero_estabelecimento: The numero_estabelecimento of this DesfazimentoTransacaoOnURequest.
        :type: int
        """
    ...
    def data_hora_terminal(self):
        """
        Gets the data_hora_terminal of this DesfazimentoTransacaoOnURequest.
    ...
    def data_hora_terminal(self, data_hora_terminal):
        """
        Sets the data_hora_terminal of this DesfazimentoTransacaoOnURequest.
        Apresenta a data e hora local da consulta yyyy-MM-dd'T'HH:mm:ss.SSSZ. Ex: 2000-10-31T01:30:00.000-05:00
    ...
    def terminal_requisitante(self):
        """
        Gets the terminal_requisitante of this DesfazimentoTransacaoOnURequest.
        Apresenta a identifica\u00C3\u00A7\u00C3\u00A3o do terminal requisitante

        :return: The terminal_requisitante of this DesfazimentoTransacaoOnURequest.
        :rtype: str
        """
    ...
    def terminal_requisitante(self, terminal_requisitante):
        """
        Sets the terminal_requisitante of this DesfazimentoTransacaoOnURequest.
        Apresenta a identifica\u00C3\u00A7\u00C3\u00A3o do terminal requisitante

        :param terminal_requisitante: The terminal_requisitante of this DesfazimentoTransacaoOnURequest.
        :type: str
        """
