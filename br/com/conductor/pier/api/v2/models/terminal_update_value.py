...
class TerminalUpdateValue(object):
    """
    ...
    def __init__(self):
        """
        TerminalUpdateValue - a model defined in Swagger
    ...
    def flag_consulta_extrato(self):
        """
        Gets the flag_consulta_extrato of this TerminalUpdateValue.
        {{{terminal_update_flag_consulta_extrato_value}}}

        :return: The flag_consulta_extrato of this TerminalUpdateValue.
        :rtype: bool
        """
    ...
    def flag_consulta_extrato(self, flag_consulta_extrato):
        """
        Sets the flag_consulta_extrato of this TerminalUpdateValue.
        {{{terminal_update_flag_consulta_extrato_value}}}

        :param flag_consulta_extrato: The flag_consulta_extrato of this TerminalUpdateValue.
        :type: bool
        """
    ...
    def flag_terminal_virtual(self):
        """
        Gets the flag_terminal_virtual of this TerminalUpdateValue.
        {{{terminal_update_flag_terminal_virtual_value}}}

        :return: The flag_terminal_virtual of this TerminalUpdateValue.
        :rtype: bool
        """
    ...
    def flag_terminal_virtual(self, flag_terminal_virtual):
        """
        Sets the flag_terminal_virtual of this TerminalUpdateValue.
        {{{terminal_update_flag_terminal_virtual_value}}}

        :param flag_terminal_virtual: The flag_terminal_virtual of this TerminalUpdateValue.
        :type: bool
        """
