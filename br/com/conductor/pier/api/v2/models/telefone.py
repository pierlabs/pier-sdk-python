...
class Telefone(object):
    ...
    def __init__(self):
        """
        Telefone - a model defined in Swagger
    ...
    def id(self):
        """
        Gets the id of this Telefone.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Telefone (id).

        :return: The id of this Telefone.
        :rtype: int
        """
        return self._id
    ...
    def id(self, id):
        """
        Sets the id of this Telefone.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o do Telefone (id).

        :param id: The id of this Telefone.
        :type: int
        """
        self._id = id
    ...
    def id_pessoa(self):
        ...
        :return: The id_pessoa of this Telefone.
        :rtype: int
        """
    ...
    def id_pessoa(self, id_pessoa):
        """
        Sets the id_pessoa of this Telefone.
        C\u00C3\u00B3digo de Identifica\u00C3\u00A7\u00C3\u00A3o da Pessoa (id) a qual o telefone pertence.

        :param id_pessoa: The id_pessoa of this Telefone.
        :type: int
        """
    ...
    def ramal(self):
        """
        Gets the ramal of this Telefone.
        N\u00C3\u00BAmero do ramal.
    ...
    def status(self):
        """
        Gets the status of this Telefone.
        Apresenta o Status do Telefone, onde: '0': Inativo e '1': Ativo

        :return: The status of this Telefone.
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """
        Sets the status of this Telefone.
        Apresenta o Status do Telefone, onde: '0': Inativo e '1': Ativo

        :param status: The status of this Telefone.
        :type: int
        """
        self._status = status
