...
class DocumentoTemplatePersist(object):
    """
    ...
    def __init__(self):
        """
        DocumentoTemplatePersist - a model defined in Swagger
    ...
    def id_tipo_documento(self):
        """
        Gets the id_tipo_documento of this DocumentoTemplatePersist.
        ID para o Tipo de Documento vinculado ao template.

        :return: The id_tipo_documento of this DocumentoTemplatePersist.
        :rtype: int
        """
    ...
    def id_tipo_documento(self, id_tipo_documento):
        """
        Sets the id_tipo_documento of this DocumentoTemplatePersist.
        ID para o Tipo de Documento vinculado ao template.

        :param id_tipo_documento: The id_tipo_documento of this DocumentoTemplatePersist.
        :type: int
        """
