...
class Terminal(object):
    ...
    def __init__(self):
        """
        Terminal - a model defined in Swagger
    ...
    def terminal(self):
        """
        Gets the terminal of this Terminal.
    ...
    def terminal(self, terminal):
        """
        Sets the terminal of this Terminal.
        N\u00C3\u00BAmero \u00C3\u00BAnico do terminal.

        :param terminal: The terminal of this Terminal.
        :type: str
        """
    ...
    def numero_estabelecimento(self):
        """
        Gets the numero_estabelecimento of this Terminal.
        N\u00C3\u00BAmero do estabelecimento a qual o terminal pertence.

        :return: The numero_estabelecimento of this Terminal.
        :rtype: int
        """
    ...
    def numero_estabelecimento(self, numero_estabelecimento):
        """
        Sets the numero_estabelecimento of this Terminal.
        N\u00C3\u00BAmero do estabelecimento a qual o terminal pertence.

        :param numero_estabelecimento: The numero_estabelecimento of this Terminal.
        :type: int
        """
    ...
    def id_estabelecimento(self):
        """
        Gets the id_estabelecimento of this Terminal.
        N\u00C3\u00BAmero de identifica\u00C3\u00A7\u00C3\u00A3o do estabelecimento a qual o terminal pertence.

        :return: The id_estabelecimento of this Terminal.
        :rtype: int
        """
    ...
    def id_estabelecimento(self, id_estabelecimento):
        """
        Sets the id_estabelecimento of this Terminal.
        N\u00C3\u00BAmero de identifica\u00C3\u00A7\u00C3\u00A3o do estabelecimento a qual o terminal pertence.

        :param id_estabelecimento: The id_estabelecimento of this Terminal.
        :type: int
        """
