...
"""
GlobaltaxasrefinanciamentoApi.py
...
class GlobaltaxasrefinanciamentoApi(object):
    """
    ...
    def listar_using_get51(self, **kwargs):
        ...
        all_params = ['sort', 'page', 'limit', 'id', 'id_produto', 'data_entrada', 'vencimento']
        ...
        resource_path = '/api/taxas-refinanciamento'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'data_entrada' in params:
            query_params['dataEntrada'] = params['data_entrada']
        if 'vencimento' in params:
            query_params['vencimento'] = params['vencimento']
