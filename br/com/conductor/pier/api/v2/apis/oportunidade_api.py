...
class OportunidadeApi(object):
    ...
    def alterar_using_put18(self, id, persist, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.alterar_using_put18(id, persist, callback=callback_function)
        ...
        # verify the required parameter 'persist' is set
        if ('persist' not in params) or (params['persist'] is None):
            raise ValueError("Missing the required parameter `persist` when calling `alterar_using_put18`")
