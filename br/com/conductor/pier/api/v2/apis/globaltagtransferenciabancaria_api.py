...
"""
GlobaltagtransferenciabancariaApi.py
...
class GlobaltagtransferenciabancariaApi(object):
    """
    ...
    def atualizar_using_put1(self, id, update, **kwargs):
        ...
        :param ContaBancariaPortadorUpdateValue update: update (required)
    ...
    def consultar_using_get47(self, id, id_transferencia, **kwargs):
        ...
        :param int id_conta_bancaria_destino: {{{transferencia_bancaria_resource_consultar_param_id_conta_portador}}}
    ...
    def listar_transferencia_bancaria_using_get(self, **kwargs):
        ...
        :param int id_conta: {{{transferencia_credito_conta_bancaria_request_id_conta_value}}}
        :param str data_solicitacao_inicial: {{{transferencia_credito_conta_bancaria_request_data_solicitacao_inicial_value}}}
        :param str data_solicitacao_final: {{{transferencia_credito_conta_bancaria_request_data_solicitacao_final_value}}}
        :param int status: {{{transferencia_credito_conta_bancaria_request_status_value}}}
    ...
    def listar_using_get16(self, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param int id_conta: {{{conta_bancaria_portador_listar_request_id_conta_value}}}
        :param str nome_agencia: {{{conta_bancaria_portador_listar_request_nome_agencia_value}}}
        :param int banco: {{{conta_bancaria_portador_listar_request_codigo_banco_value}}}
        :param str numero_agencia: {{{conta_bancaria_portador_listar_request_numero_agencia_value}}}
        :param str numero_conta: {{{conta_bancaria_portador_listar_request_numero_conta_value}}}
        :param int flag_ativo: {{{conta_bancaria_portador_listar_request_flag_ativo_value}}}
        :param int flag_conta_origem_doc: {{{conta_bancaria_portador_listar_request_flag_conta_origem_doc_value}}}
        :param int id_pessoa_fisica: {{{conta_bancaria_portador_listar_request_id_pessoa_fisica_value}}}
        :param str favorecido: {{{conta_bancaria_portador_listar_request_favorecido_value}}}
        :param str numero_receira_federal: {{{conta_bancaria_portador_listar_request_numero_receira_federal_value}}}
        :param list[str] sort: {{{global_menssagem_sort_sort}}}
        :param int page: {{{global_menssagem_sort_page_value}}}
        :param int limit: {{{global_menssagem_sort_limit}}}
        ...
        all_params = ['id_conta', 'nome_agencia', 'banco', 'numero_agencia', 'numero_conta', 'flag_ativo', 'flag_conta_origem_doc', 'id_pessoa_fisica', 'favorecido', 'numero_receira_federal', 'sort', 'page', 'limit']
        all_params.append('callback')
    ...
    def listar_using_get59(self, id, **kwargs):
        ...
        :param int id_conta_bancaria_destino: {{{transferencia_bancaria_resource_listar_param_id_conta_portador}}}
        :param list[str] sort: {{{global_menssagem_sort_sort}}}
        :param int page: {{{global_menssagem_sort_page_value}}}
        :param int limit: {{{global_menssagem_sort_limit}}}
    ...
    def salvar_using_post7(self, persist, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ContaBancariaPortadorPersistValue persist: persist (required)
        :return: ContaBancariaPortadorResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def transferencia_credito_conta_bancaria_using_post(self, persist, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param TransferenciaCreditoContaBancariaPersistValue persist: persist (required)
        :return: TransferenciaCreditoContaBancariaResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def transferir_using_post(self, id, transferencia_bancaria_persist, **kwargs):
        ...
        :param TransferenciaBancariaPersistValue transferencia_bancaria_persist: transferenciaBancariaPersist (required)
        :return: TransferenciaBancariaResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
