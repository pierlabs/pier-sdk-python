...
"""
GlobaltagaplicacaomobileApi.py
...
class GlobaltagaplicacaomobileApi(object):
    """
    ...
    def atualizar_using_put(self, id, update, **kwargs):
        ...
        :param AplicacaoMobileUpdateValue update: update (required)
    ...
    def listar_using_get3(self, **kwargs):
        ...
        :param str id: {{{aplicacao_mobile_request_id_value}}}
        :param int id_plataforma_mobile: {{{aplicacao_mobile_request_id_plataforma_mobile_value}}}
    ...
    def salvar_using_post(self, persist, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param AplicacaoMobilePersistValue persist: persist (required)
        :return: AplicacaoMobileResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
