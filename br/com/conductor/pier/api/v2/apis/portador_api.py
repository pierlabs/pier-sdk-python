...
class PortadorApi(object):
    ...
    def listar_using_get4(self, **kwargs):
        ...
        all_params = ['id_conta', 'id_produto', 'id_pessoa', 'id_parentesco', 'tipo_portador', 'nome_impresso', 'flag_ativo', 'data_cadastro_portador', 'data_cancelamento_portador', 'page', 'limit']
