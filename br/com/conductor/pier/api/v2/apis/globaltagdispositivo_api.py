...
class GlobaltagdispositivoApi(object):
    """
    ...
    def listar_using_get21(self, **kwargs):
        ...
        :param str token: {{{dispositivo_request_token_value}}}
        :param int id_usuario: {{{dispositivo_request_id_usuario_value}}}
        :param int id_aplicacao_mobile: {{{dispositivo_request_id_aplicacao_mobile_value}}}
        :param str data_criacao: {{{dispositivo_request_data_criacao_value}}}
        :param str data_desativacao: {{{dispositivo_request_data_desativacao_value}}}
    ...
    def salvar_using_post11(self, persist, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param DispositivoPersistValue persist: persist (required)
        :return: DispositivoResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
