...
class JobsApi(object):
    ...
    def salvar_using_post8(self, descricao, cron, groovy, **kwargs):
        """
        Cadastrar Job
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.salvar_using_post8(descricao, cron, groovy, callback=callback_function)
        ...
        # verify the required parameter 'descricao' is set
        if ('descricao' not in params) or (params['descricao'] is None):
            raise ValueError("Missing the required parameter `descricao` when calling `salvar_using_post8`")
        # verify the required parameter 'cron' is set
        if ('cron' not in params) or (params['cron'] is None):
            raise ValueError("Missing the required parameter `cron` when calling `salvar_using_post8`")
        # verify the required parameter 'groovy' is set
        if ('groovy' not in params) or (params['groovy'] is None):
            raise ValueError("Missing the required parameter `groovy` when calling `salvar_using_post8`")
