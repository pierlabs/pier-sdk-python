...
class UsuarioApi(object):
    ...
    def alterar_using_put21(self, id, update, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.alterar_using_put21(id, update, callback=callback_function)
        ...
        if ('update' not in params) or (params['update'] is None):
            raise ValueError("Missing the required parameter `update` when calling `alterar_using_put21`")
