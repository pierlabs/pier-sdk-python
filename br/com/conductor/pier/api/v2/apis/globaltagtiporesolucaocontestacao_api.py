...
"""
GlobaltagtiporesolucaocontestacaoApi.py
...
class GlobaltagtiporesolucaocontestacaoApi(object):
    """
    ...
    def listar_tipo_resolucao_contestacao_using_get(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.listar_tipo_resolucao_contestacao_using_get(callback=callback_function)
        ...
        :param int page: {{{global_menssagem_sort_page_value}}}
        :param int limit: {{{global_menssagem_sort_limit}}}
        :param int id_tipo_resolucao_contestacao: {{{tipo_resolucao_contestacao_request_idTipoResolucaoContestacao_value}}}
        :param str descricao: {{{tipo_resolucao_contestacao_request_descricao_value}}}
        :return: PageTipoResolucaoContestacaoResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """

        all_params = ['sort', 'page', 'limit', 'id_tipo_resolucao_contestacao', 'descricao']
        all_params.append('callback')
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method listar_tipo_resolucao_contestacao_using_get" % key
                )
            params[key] = val
        del params['kwargs']


        resource_path = '/api/tipos-resolucoes-contestacoes'.replace('{format}', 'json')
        path_params = {}
        ...
        if 'limit' in params:
            query_params['limit'] = params['limit']
        if 'id_tipo_resolucao_contestacao' in params:
            query_params['idTipoResolucaoContestacao'] = params['id_tipo_resolucao_contestacao']
        if 'descricao' in params:
            query_params['descricao'] = params['descricao']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='PageTipoResolucaoContestacaoResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
