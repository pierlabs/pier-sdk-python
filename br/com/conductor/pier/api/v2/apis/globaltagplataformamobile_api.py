...
"""
GlobaltagplataformamobileApi.py
...
class GlobaltagplataformamobileApi(object):
    """
    ...
    def atualizar_using_put1(self, id, update, **kwargs):
        ...
        :param PlataformaMobileUpdateValue update: update (required)
    ...
    def listar_using_get40(self, **kwargs):
        ...
        :param str nome: {{{plataforma_mobile_request_nome_value}}}
    ...
    def salvar_using_post26(self, persist, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param PlataformaMobilePersistValue persist: persist (required)
        :return: PlataformaMobileResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
