...
class WebhooksApi(object):
    ...
    def salvar_using_post4(self, evento, metodo, url, **kwargs):
        """
        Salvar Webhook
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.salvar_using_post4(evento, metodo, url, callback=callback_function)
        ...
        # verify the required parameter 'evento' is set
        if ('evento' not in params) or (params['evento'] is None):
            raise ValueError("Missing the required parameter `evento` when calling `salvar_using_post4`")
        # verify the required parameter 'metodo' is set
        if ('metodo' not in params) or (params['metodo'] is None):
            raise ValueError("Missing the required parameter `metodo` when calling `salvar_using_post4`")
        # verify the required parameter 'url' is set
        if ('url' not in params) or (params['url'] is None):
            raise ValueError("Missing the required parameter `url` when calling `salvar_using_post4`")
