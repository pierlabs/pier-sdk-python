...
class ContaApi(object):
    ...
    def alterar_limite_using_put(self, id_conta, limite_global, limite_compra, limite_parcelado, limite_parcelas, limite_saque_global, limite_saque_periodo, limite_consignado, limite_internacional_compra, limite_internacional_parcelado, limite_internacional_parcelas, limite_internacional_saque_global, limite_internacional_saque_periodo, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.alterar_limite_using_put(id_conta, limite_global, limite_compra, limite_parcelado, limite_parcelas, limite_saque_global, limite_saque_periodo, limite_consignado, limite_internacional_compra, limite_internacional_parcelado, limite_internacional_parcelas, limite_internacional_saque_global, limite_internacional_saque_periodo, callback=callback_function)
        ...
        all_params = ['id_conta', 'limite_global', 'limite_compra', 'limite_parcelado', 'limite_parcelas', 'limite_saque_global', 'limite_saque_periodo', 'limite_consignado', 'limite_internacional_compra', 'limite_internacional_parcelado', 'limite_internacional_parcelas', 'limite_internacional_saque_global', 'limite_internacional_saque_periodo']
        ...
        if ('id_conta' not in params) or (params['id_conta'] is None):
            raise ValueError("Missing the required parameter `id_conta` when calling `alterar_limite_using_put`")
        ...
        resource_path = '/api/contas/{id_conta}/alterar-limites'.replace('{format}', 'json')
        path_params = {}
    ...
    def gerar_cartao_using_post(self, id_conta, id_pessoa, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.gerar_cartao_using_post(id_conta, id_pessoa, callback=callback_function)
        ...
        # verify the required parameter 'id_conta' is set
        if ('id_conta' not in params) or (params['id_conta'] is None):
            raise ValueError("Missing the required parameter `id_conta` when calling `gerar_cartao_using_post`")
