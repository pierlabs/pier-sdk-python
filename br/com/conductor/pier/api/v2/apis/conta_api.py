...
class ContaApi(object):
    ...
    def alterar_produto_using_post(self, id, id_produto, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.alterar_produto_using_post(id, id_produto, callback=callback_function)
        ...
        if ('id_produto' not in params) or (params['id_produto'] is None):
            raise ValueError("Missing the required parameter `id_produto` when calling `alterar_produto_using_post`")
    ...
    def consultar_fatura_consignada_aberta_using_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.consultar_fatura_consignada_aberta_using_get(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method consultar_fatura_consignada_aberta_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `consultar_fatura_consignada_aberta_using_get`")
    ...
    def consultar_fatura_consignada_using_get(self, id, id_fatura, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.consultar_fatura_consignada_using_get(id, id_fatura, callback=callback_function)
        ...
        if ('id_fatura' not in params) or (params['id_fatura'] is None):
            raise ValueError("Missing the required parameter `id_fatura` when calling `consultar_fatura_consignada_using_get`")

        resource_path = '/api/contas/{id}/faturas-consignadas/{id_fatura}'.replace('{format}', 'json')
        path_params = {}
        if 'id' in params:
            path_params['id'] = params['id']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='FaturaConsignadaDetalheResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response
    ...
    def consultar_fatura_using_get(self, id, data_vencimento, **kwargs):
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method consultar_fatura_using_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        response = self.api_client.call_api(resource_path, 'GET',
                                            ...
                                            post_params=form_params,
                                            files=local_var_files,
                                            response_type='DetalhesFaturaResponse',
                                            auth_settings=auth_settings,
                                            callback=params.get('callback'))
        return response

    def consultar_lancamentos_futuros_fatura_using_get(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.consultar_lancamentos_futuros_fatura_using_get(id, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method consultar_lancamentos_futuros_fatura_using_get" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def consultar_lancamentos_futuros_fatura_using_get1(self, id, data_vencimento_padrao, **kwargs):
        ...
        all_params = ['id', 'data_vencimento_padrao', 'sort', 'page', 'limit', 'quantidade_parcelas']
        all_params.append('callback')
    ...
    def gerar_cartao_embossing_using_post(self, id, id_pessoa, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.gerar_cartao_embossing_using_post(id, id_pessoa, callback=callback_function)
        ...
        # verify the required parameter 'id_pessoa' is set
        if ('id_pessoa' not in params) or (params['id_pessoa'] is None):
            raise ValueError("Missing the required parameter `id_pessoa` when calling `gerar_cartao_embossing_using_post`")
    ...
    def listar_faturas_consignadas_using_get(self, id, **kwargs):
        ...
        all_params = ['id', 'sort', 'page', 'limit', 'data_vencimento']
        all_params.append('callback')
    ...
    def listar_using_get30(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.listar_using_get30(id, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `listar_using_get30`")
    ...
    def listar_using_get31(self, id, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.listar_using_get31(id, callback=callback_function)
        ...
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `listar_using_get31`")
