...
class CartaoResponseApi(object):
    """
    ...
    def consultar_cartao_using_get(self, id_emissor, id_conta, id_cartao, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.consultar_cartao_using_get(id_emissor, id_conta, id_cartao, callback=callback_function)
        ...
        all_params = ['id_emissor', 'id_conta', 'id_cartao', 'numero_cartao']
        all_params.append('callback')
    ...
    def consultar_cartoes_using_get(self, id_emissor, id_conta, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.consultar_cartoes_using_get(id_emissor, id_conta, callback=callback_function)
        ...
        # verify the required parameter 'id_emissor' is set
        if ('id_emissor' not in params) or (params['id_emissor'] is None):
            raise ValueError("Missing the required parameter `id_emissor` when calling `consultar_cartoes_using_get`")
        # verify the required parameter 'id_conta' is set
        if ('id_conta' not in params) or (params['id_conta'] is None):
